...
from document.domain.parser.image_descriptor.prompts import PPTX_SYSTEM_PROMPT
from document.domain.parser.image_descriptor.prompts import FIRST_SLIDE_SYSTEM_PROMPT
